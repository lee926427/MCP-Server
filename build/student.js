...
import { z } from "zod";
export const setupStudent = (server) => {
    server.resource("get_all_students", new ResourceTemplate("students://all", { list: undefined }), async (uri) => {
    ...
    server.tool('search_student', 'search student by name or age', {
    ...
    server.tool('add_student', 'add student by name and age', {
        name: z.string().min(1).describe('The name of the student'),
